...
import Step4_04_FusionTwoSensors from '../../pages/documents/step4/04_FusionTwoSensors/04_FusionTwoSensors';
...
export default function Section4Routes() {
    return [
        ...
        <Route key="Step4_04_FusionTwoSensors" path="/Step4_04_FusionTwoSensors" element={<ProtectedRoute><Step4_04_FusionTwoSensors /></ProtectedRoute>} />,
    ];
}
