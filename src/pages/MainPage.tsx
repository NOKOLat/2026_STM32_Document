    ...
    return (
        ...
        <div>
            ...
            <section>
                ...
                <MainPageSection title="Step 1 開発環境を用意しよう">
                ...
                <MainPageSection title="Step 2 PCと通信してみよう">
                ...
                <MainPageSection title="Step 3 外部の入力を受け取ってみよう">
                    <p>飛行機やマルチコプターを飛ばすときに使うプロポの情報を受け取ってみよう</p>

                    <p>実際に大会で重要になる"自動投下装置"を作成してみよう</p>

                    <PageLinkButton section={3} number={0} link="/mainpage" title="今回作る 『自動投下装置』について" />

                    <PageLinkButton section={3} number={1} link="/mainpage" title="プロポからデータを受信してみよう" />

                    <PageLinkButton section={3} number={2} link="/mainpage" title="サーボモーターを動かしてみよう" />

                    <PageLinkButton section={3} number={3} link="/mainpage" title="赤外線を読んでみよう" />
                </MainPageSection>
